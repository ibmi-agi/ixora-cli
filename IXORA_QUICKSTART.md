...
| `ixora stack system add` | Add a system: managed (provision an IBM i stack) or external (register an AgentOS URL). Flags: `--kind external --id ID --agentos-url URL [--agentos-key KEY]` |
